...
}).fail(() => showNotification('error', 'خطا!', "مشکلی در دریافت اطلاعات سرور پیش آمده امکان دارد سرور در دسترس نباشد  یا اتصال شما به سرور به مشکل خورده است لطفا اعلامیه ها را دنبال کنید یا اینترنت خود را بررسی کنید.", true));
