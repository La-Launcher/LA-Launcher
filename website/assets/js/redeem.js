    ...
    if (!serverData.status) {
        ...
        function drop() {
            ...
            $el.one('transitionend', () => {
                $el.remove();
                openLauncherWithRedeem(redeemCode);
            });
        }
